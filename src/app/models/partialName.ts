...
//
//   const partialName = Convert.toPartialName(json);
//
...
export class Convert {
    public static toPartialName(json: string): PartialName[] {
        return cast(JSON.parse(json), a(r("PartialName")));
    }

    public static partialNameToJson(value: PartialName[]): string {
        return JSON.stringify(uncast(value, a(r("PartialName"))), null, 2);
    }
}
