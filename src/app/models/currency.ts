...
export interface Currency {
    ...
    status:       Status;
    unMember:     boolean;
    currencies:   { [key: string]: CurrencyValue };
    idd:          Idd;
    capital?:     string[];
    altSpellings: string[];
    region:       Region;
...
export class Convert {
    public static toCurrency(json: string): Currency[] {
        return cast(JSON.parse(json), a(r("Currency")));
    }

    public static currencyToJson(value: Currency[]): string {
        return JSON.stringify(uncast(value, a(r("Currency"))), null, 2);
    }
}
...
const typeMap: any = {
    "Currency": o([
        ...
        { json: "currencies", js: "currencies", typ: m(r("CurrencyValue")) },
